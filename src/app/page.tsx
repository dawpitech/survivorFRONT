      ...
      <main>
        ...
        <section className="flex flex-col items-center justify-center">
          ...
          <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-10">
            <article className="border border-gray-200 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-4 bg-white">
              <img src="/project.jpeg" alt="new startup" />
              <h3 className="mt-[1rem] font-bold text-lg">Projet 1</h3>
              <p>
                Introducing Dnsys Z1, the world’s first knee exoskeleton built
                for power and protection
              </p>
            </article>
            <article className="border border-gray-200 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-4 bg-white">
              <img src="/project.jpeg" alt="new startup" />
              <h3 className="mt-[1rem] font-bold text-lg">Projet 2</h3>
              <p>
                Introducing Dnsys Z1, the world’s first knee exoskeleton built
                for power and protection
              </p>
            ...
            <article className="border border-gray-200 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-4 bg-white">
              <img src="/project.jpeg" alt="new startup" />
              <h3 className="mt-[1rem] font-bold text-lg">Projet 3</h3>
              <p>
                Introducing Dnsys Z1, the world’s first knee exoskeleton built
                for power and protection
              </p>
