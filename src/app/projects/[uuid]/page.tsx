                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                {project.legal_status && (
                                    <div className="mb-3">
                                        <span className="font-medium">Legal status:</span> {project.legal_status}
                                    </div>
                                )}

                                {project.maturity && (
                                    <div className="mb-3">
                                        <span className="font-medium">Maturity:</span> {project.maturity}
                                    </div>
                                )}

                                {project.project_status && (
                                    <div className="mb-3">
                                        <span className="font-medium">Project status:</span> {project.project_status}
                                    </div>
                                )}
                            ...
                            <div>
                                ...
                                <div className="mb-3">
                                    ...
                                    <a href={`mailto:${project.email}`} className="text-blue-600 hover:underline ml-2">
                                        {project.email}
                                    </a>
                                </div>
                                ...
                                {project.website_url && (
                                    <div className="mb-3">
                                        ...
                                        <a href={project.website_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline ml-2">
                                            {project.website_url}
                                        </a>
                                    </div>
                                )}
                                ...
                                {project.social_media_url && (
                                    <div className="mb-3">
                                        ...
                                        <a href={project.social_media_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline ml-2">
                                            {project.social_media_url}
                                        </a>
                                    </div>
                                )}
